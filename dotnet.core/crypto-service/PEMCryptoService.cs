...
{    
    public class PEMCryptoService
    {
        ...
        private Nullable<RSAParameters> DecodeX509PublicKey(byte[] x509Key)
        {
        ...
        private Nullable<RSAParameters> DecodeRSAPrivateKey( byte[] privkey )
        {
        ...
        public String CreateJWTToken(String privateKeyPath, String issuer, Claim[] claims) {
            var privateKeyBytes = File.ReadAllBytes(privateKeyPath);
            var key = new SymmetricSecurityKey(privateKeyBytes);
